    ...
    <div className="card">
      ...
      <div className="card-body">
        <div className="form-row">
          ...
          <input className="input sm discretion-pct" type="number" min="0" max="100" value={state.inc ?? ""} onChange={e => setPctField("inc", e.target.value)} />
        </div>
        <div className="form-row">
          <label>%age Decrease in SENTENCE/FINE<span className="sub-label">(System default 0%)</span></label>
          <input className="input sm discretion-pct" type="number" min="0" max="100" value={state.dec ?? ""} onChange={e => setPctField("dec", e.target.value)} />
        </div>
